<section class="featured">
  <div class="container text-center my-5 pb-5">
    <h3><span>Gadgets </span></h3>
    <hr class="mx-auto" />
    <p>Here you can check out our super collection of gadgets and watches</p>
  </div>
  <div class="row mx-auto mint container-fluid">
    <?php include('server/get_gadgets.php'); ?>
    <?php while ($row = $gadgets->fetch_assoc()) { ?>
